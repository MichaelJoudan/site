...
(() => {
  ...
  window.addEventListener("themechange", () => requestAnimationFrame(() => window.renderHeat()));
  const mq = window.matchMedia("(prefers-color-scheme: dark)");
  mq.addEventListener && mq.addEventListener("change", () => requestAnimationFrame(() => window.renderHeat()));
})();
